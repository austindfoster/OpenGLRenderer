...
Mesh Model::processMesh(aiMesh *mesh, const aiScene *scene)
{
    ...
    mat.ambient = {ambient.r, ambient.g, ambient.b};
    mat.emmisive = {emmisive.r, emmisive.g, emmisive.b};
    mat.transparent = {transparent.r, transparent.g, transparent.b};
    mat.reflective = {reflective.r, reflective.g, reflective.b};
